import "./BackgroundPS.scss";

function BackgroundPS() {
  return (
    <div className="backwrap gradient">
      <div className="back-shapes">
        ...
        <span
          className="floating circle"
          style={{top:"39.7344228804903%", left:"10.833333333333334%", animationDelay:"-3.35s"}}
        ></span>
        <span
          className="floating triangle"
          style={{top:"77.83452502553627%", left:"24.427083333333332%", animationDelay:"-2.3s"}}
        ></span>
        <span
          className="floating triangle"
